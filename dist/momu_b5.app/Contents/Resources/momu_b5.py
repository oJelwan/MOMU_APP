...
if dia == "14" or dia == "15" or dia == "16":
    c = 'mkdir -p ~/Documents/momu_la_bola/backups/' + today
    os.system(c)
    d = 'cp *.db ~/Documents/momu_la_bola/backups/' + today
    os.system(d) 
...
# Daily backup but yesterday's lol
...
#*** notebook registro ***
f_ventas = F_Ventas(nb_all, AutocompleteEntry, hoy, lista_productos, lista_claves, lista_total, productos_db, venta_db, tmpR1_db, clien_db)
...
# *** notebook inventario ***
f_compras = F_Compras(nb_all, AutocompleteEntry, hoy, lista_productos, lista_claves, lista_total, productos_db, compra_db, tmpI1_db, clien_db, reg_db)
...
# *** notebook reportes ***
f_reportes = F_reportes(nb_all, AutocompleteEntry, hoy, lista_productos, lista_claves, lista_total, venta_db, cot_db, productos_db, compra_db, clien_db, reg_db, reporte_db)
...
# # 1st frame - R functions 
# def venta():
#     f_root.grid_remove()
#     nb_registro.grid_remove()
#     nb_inventario.grid_remove()
#     nb_venta.grid()
#     nb_venta.focus_set()
#     f_venta.ve_prod.focus_set()
#     root.title("Venta")
...
# def registro():
#     f_root.grid_remove()
#     nb_venta.grid_remove()
#     nb_inventario.grid_remove()
#     nb_registro.grid()
#     nb_registro.focus_set()
#     f_ventas.filtrar()
#     f_cotizaciones.filtrar()
#     f_ventas.ve_numventa.focus_set()
#     root.title("Registro")
# def r(event):
#     registro()
...
# ROOT
# r_clock = Clock(f_root)
# r_clock.grid(row = 0, column = 4)


# rb_venta = tk.Button(f_root, text = "VENTA", font= ("AppleGothic"), width = 6, height = 2, command = venta)
# rb_venta.grid(row = 0, column = 0,padx = 7, pady = 5)

# rb_registro = tk.Button(f_root, text = "REGISTROS", font= ("AppleGothic"), width = 10, height = 2, command = registro)
# rb_registro.grid(row = 0, column = 3)

# rb_inventario = tk.Button(f_root, text = "INVENTARIO", font= ("AppleGothic"), width = 10, height = 2, command = inventario)
# rb_inventario.grid(row = 1, column = 3)



# ************************************ MENUS ********************************
#     # menu a root - venta
# vb_menu = tk.Button(f_venta, text = "Menu", width = 7, height = 1, font= ("AppleGothic"), command = menu)
# vb_menu.grid(row = 4, column = 0,pady = 10) 

#     # menu a root - registro1
# vbc_menu = tk.Button(f_ventas.prueba, text = "Menu", width = 7, height = 1, font= ("AppleGothic"), command = menu)
# vbc_menu.grid(row =4, column = 0, sticky = tk.W, padx = 18) 

#     # menu a root - registro2
# vbc_menu = tk.Button(f_cotizaciones.prueba, text = "Menu", width = 7, height = 1, font= ("AppleGothic"), command = menu)
# vbc_menu.grid(row = 5, column = 0, sticky = tk.W, padx = 18) 

#     # menu a root - inventario1
# vbc_menu = tk.Button(f_compras.prueba, text = "Menu", width = 7, height = 1, font= ("AppleGothic"), command = menu)
# vbc_menu.grid(row = 5, column = 0, sticky = tk.W, padx = 20) 

#     # menu a root - inventario2
# vbc_menu = tk.Button(f_productos.prueba, text = "Menu", width = 7, height = 1, font= ("AppleGothic"), command = menu)
# vbc_menu.grid(row = 5, column = 0, sticky = tk.W, padx = 20) 
